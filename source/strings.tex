...
namespace std {
  ...
  short float stosf(const string& str, size_t* idx = nullptr);
  ...
  short float stosf(const wstring& str, size_t* idx = nullptr);
...
\begin{itemdescr}
\pnum
\effects These functions respectively call
\tcode{strtosf(str.c_str(), ptr)}, 
\tcode{strtof(str.c_str(), ptr)}, \tcode{strtod(str.c_str(), ptr)}, and
\tcode{strtold(\brk{}str.c_str(), ptr)}. Each function returns
...
\pnum
\effects These functions respectively call 
\tcode{wcstosf(str.c_str(), ptr)},
\tcode{wcstof(str.c_str(), ptr)},
\tcode{wcstod(str.c_str(), ptr)}, and \tcode{wcstold(\brk{}str.c_str(), ptr)}. Each function returns the converted
...
namespace std {
  ...
  short float wcstosf(const wchar_t* nptr, wchar_t** endptr);

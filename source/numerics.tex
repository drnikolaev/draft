...
\tcode{complex}
for any type other than \tcode{short float},
\tcode{float}, \tcode{double}, or \tcode{long double} is unspecified.
The specializations
\tcode{complex<short float>},
\tcode{complex<float>},
...
namespace std {
  ...
  public:
    ...
    constexpr explicit complex(const complex<short float>&);
...
\begin{itemize}
        ...
        \item Otherwise, if the argument has type \tcode{short float}, then it is
              effectively cast to \tcode{complex<short float>}.
\end{itemize}
...
\begin{itemize}
  ...
  \item Otherwise, if either argument has type \tcode{complex<short float>} or
        \tcode{short float}, then both arguments are effectively cast to
        \tcode{complex<short float>}.
\end{itemize}
...
The suffixes \tcode{i}, \tcode{il}, \tcode{if} and \tcode{isf} create complex numbers of
the types \tcode{complex<double>}, \tcode{complex<long double>}, \tcode{complex<float>} and
\tcode{complex<short float>} respectively, with their imaginary part denoted by the
...
\indexlibrarymember{operator""""isf}{complex}%
\begin{itemdecl}
...
\pnum
\returns
\tcode{complex<short float>\{0.0sf, static_cast<short float>(d)\}}.
\end{itemdescr}
...
\begin{enumeratea}
  ...
  \item
    ...
    is cv-unqualified and
    is one of
    \tcode{short float}, \tcode{float}, \tcode{double}, or \tcode{long double}.
  \item
    that has a template type parameter
    named \tcode{IntType}
    is undefined unless the corresponding template argument
...
\indexlibrary{\idxcode{short_float_t}}%
...
namespace std {
  ...
  short float acossf(short float x);
  float acosf(float x);
  ...
  short float asinsf(short float x);
  float asinf(float x);
  ...
  short float atansf(short float x);
  float atanf(float x);
  ...
  short float atan2sf(short float x);
  ...
  short float cossf(short float x);
  float cosf(float x);
  ...
  short float sinsf(short float x);
  float sinf(float x);
  ...
  short float tansf(short float x);
  float tanf(float x);
  ...
  short float acoshsf(short float x);
  ...
  short float asinhsf(short float x);
  ...
  short float atanhsf(short float x);
  ...
  short float coshsf(short float x);
  float coshf(float x);
  ...
  short float sinhsf(short float x);
  float sinhf(float x);
  ...
  short float tanhsf(short float x);
  float tanhf(float x);
  ...
  short float expsf(short float x);
  float expf(float x);
  ...
  short float exp2sf(short float x);
  float exp2f(float x);
  ...
  short float expm1sf(short float x);
  ...
  short float frexpsf(short float x);
  ...
  short float ldexpsf(short float x, int exp);
  ...
  short float logsf(short float x);
  float logf(float x);
  ...
  short float log2sf(short float x);
  float log2f(float x);
  ...
  short float logbsf(short float x);
  float logbf(float x);
  ...
  short float modfsf(short float value, float* iptr);
  ...
  short float scalbnsf(short float x, int n);
  ...
  short float scalblnsf(short float x, long int n);
  ...
  short float cbrtsf(short float x);
  float cbrtf(float x);
  ...
  short float fabssf(short float x);
  float fabsf(float x);
  ...
  short float hypotsf(short float x, short float y);
  ...
  short float powsf(short float x, short float y);
  ...
  short float sqrtsf(short float x);
  float sqrtf(float x);
  ...
  short float erfsf(short float x);
  float erff(float x);
  ...
  short float erfcsf(short float x);
  float erfcf(float x);
  ...
  short float lgammasf(short float x);
  ...
  short float tgammasf(short float x);
  ...
  short float ceilsf(short float x);
  float ceilf(float x);
  ...
  short float floorsf(short float x);
  ...
  short float nearbyintsf(short float x);
  ...
  short float rintsf(short float x);
  float rintf(float x);
  ...
  long int lrintsf(short float x);
  ...
  long long int llrintsf(short float x);
  ...
  short float roundsf(short float x);
  ...
  long int lroundsf(short float x);
  ...
  long long int llroundsf(short float x);
  ...
  short float truncsf(short float x);
  ...
  short float fmodsf(short float x, short float y);
  ...
  short float remaindersf(short float x, short float y);
  ...
  short float remquosf(short float x, short float y, int* quo);
  ...
  short float copysignsf(short float x, short float y);
  float copysignf(float x, float y);
  long double copysignl(long double x, long double y);

  double nan(const char* tagp);
  short float nansf(const char* tagp);
  ...
  short float nextaftersf(short float x, short float y);
  ...
  short float nexttowardsf(short float x, long double y);
  ...
  short float fdimsf(short float x, short float y);
  ...
  short float fmaxsf(short float x, short float y);
  ...
  short float fminsf(short float x, short float y);
  ...
  short float fmaf(short float x, short float y, short float z);
  ...
  short float  sph_neumannsf(unsigned n, short float x);
...
\tcode{fabsf}, \tcode{fabssf}, \tcode{fabs}, and \tcode{fabsl}.
...
\indexlibrary{\idxcode{assoc_laguerresf}}%
...
\indexlibrary{\idxcode{assoc_legendresf}}%
...
\begin{itemdecl}
double       assoc_legendre(unsigned l, unsigned m, double x);
short float  assoc_legendresf(unsigned l, unsigned m, short float x);
float        assoc_legendref(unsigned l, unsigned m, float x);
long double  assoc_legendrel(unsigned l, unsigned m, long double x);
\end{itemdecl}
...
\indexlibrary{\idxcode{comp_ellint_1sf}}%
...
\indexlibrary{\idxcode{comp_ellint_2sf}}%
...
\indexlibrary{\idxcode{comp_ellint_3sf}}%
...
\begin{itemdecl}
double       comp_ellint_3(double k, double nu);
short float  comp_ellint_3f(short float k, short float nu);
float        comp_ellint_3f(float k, float nu);
long double  comp_ellint_3l(long double k, long double nu);
\end{itemdecl}
...
\indexlibrary{\idxcode{cyl_bessel_isf}}%
...
\begin{itemdecl}
double       cyl_bessel_i(double nu, double x);
short float  cyl_bessel_if(short float nu, short float x);
float        cyl_bessel_if(float nu, float x);
long double  cyl_bessel_il(long double nu, long double x);
\end{itemdecl}
...
\indexlibrary{\idxcode{cyl_bessel_jsf}}%
...
\begin{itemdecl}
double       cyl_bessel_j(double nu, double x);
short float  cyl_bessel_jf(short float nu, short float x);
float        cyl_bessel_jf(float nu, float x);
long double  cyl_bessel_jl(long double nu, long double x);
\end{itemdecl}
...
\indexlibrary{\idxcode{cyl_bessel_ksf}}%
...
\begin{itemdecl}
double       cyl_bessel_k(double nu, double x);
short float  cyl_bessel_kf(short float nu, short float x);
float        cyl_bessel_kf(float nu, float x);
long double  cyl_bessel_kl(long double nu, long double x);
\end{itemdecl}
...
\indexlibrary{\idxcode{cyl_neumannsf}}%
...
\begin{itemdecl}
double       cyl_neumann(double nu, double x);
short float  cyl_neumannf(short float nu, short float x);
float        cyl_neumannf(float nu, float x);
long double  cyl_neumannl(long double nu, long double x);
\end{itemdecl}
...
\indexlibrary{\idxcode{ellint_1sf}}%
...
\indexlibrary{\idxcode{ellint_2sf}}%
...
\begin{itemdecl}
double       ellint_2(double k, double phi);
short float  ellint_2f(short float k, short float phi);
float        ellint_2f(float k, float phi);
long double  ellint_2l(long double k, long double phi);
\end{itemdecl}
...
\indexlibrary{\idxcode{ellint_3sf}}%
...
\begin{itemdecl}
double       ellint_3(double k, double nu, double phi);
short float  ellint_3f(short float k, short float nu, short float phi);
float        ellint_3f(float k, float nu, float phi);
long double  ellint_3l(long double k, long double nu, long double phi);
\end{itemdecl}
...
\begin{itemdecl}
double       expint(double x);
short float  expintf(short float x);
float        expintf(float x);
long double  expintl(long double x);
\end{itemdecl}
...
\indexlibrary{\idxcode{hermitesf}}%
...
\indexlibrary{\idxcode{laguerresf}}%
...
\begin{itemdecl}
double       laguerre(unsigned n, double x);
short float  laguerref(unsigned n, short float x);
float        laguerref(unsigned n, float x);
long double  laguerrel(unsigned n, long double x);
\end{itemdecl}
...
\indexlibrary{\idxcode{legendresf}}%
...
\indexlibrary{\idxcode{riemann_zetasf}}%
...
\indexlibrary{\idxcode{sph_besselsf}}%
...
\indexlibrary{\idxcode{sph_legendresf}}%
...
\indexlibrary{\idxcode{sph_neumannsf}}%

...
A prvalue of type \tcode{short float} can be converted to a prvalue of type
\tcode{float} and type \tcode{double}. The value is unchanged.

\pnum
These conversions are called \defn{floating-point promotions}.

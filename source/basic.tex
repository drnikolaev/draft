...
\pnum
There are four \defnx{floating-point types}{type!floating-point}:
\indextext{type!\idxcode{short float}}%
\tcode{short float},
...
precision as \tcode{float}, the type \tcode{float} provides at least as much
precision as \tcode{short float}, and the type \tcode{long double} provides at
...
\tcode{double};
the set of values of the type \tcode{short float} is a subset
of the set of values of the type \tcode{float};
the set of values of the type \tcode{double} is a subset

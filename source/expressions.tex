...
A prvalue of types \tcode{short float} and \tcode{float} can be converted to a prvalue of type
...
\item Otherwise, if either operand is \tcode{short float}, the other shall be
converted to \tcode{short float}.
